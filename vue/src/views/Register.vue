  ...
  <div class="container">
    <div style="height: 60px; background-color: white">
      <div style="width: 60%; height: 100%; display: flex; align-items: center; margin:  0 auto">
        ...
        <span style="color: #f8a23d; font-size: 24px; font-weight: bold; margin-left: 10px">长者线上服务平台</span>
      </div>
    </div>
    <div style="height: calc(100vh - 60px); width: 60%; margin:  0 auto; display: flex; align-items: center">
      ...
      <div style="width: 350px; padding: 50px 30px; box-shadow:  0 0 10px rgba(0, 0, 0 ,.1); background-color: white; border-radius: 5px;">
        <div style="text-align: center; font-size: 22px; margin-bottom: 30px; font-weight: bold; color: #f8a23d;">欢 迎 注 册</div>
        <el-form :model="form" :rules="rules" ref="formRef">
          ...
          <el-form-item>
            <el-button style="width: 100%; background-color: #f8a23d; border-color: #f8a23d; color: white" @click="register">注 册</el-button>
          </el-form-item>
